          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? (
                ...
                <TableRow><TableCell colSpan={6} className="py-10 text-center text-muted-foreground">No parts yet.</TableCell></TableRow>
              ) : (
                parts.map((p) => {
                  ...
                  return (
                    <TableRow key={p.id}>
                      ...
                      <TableCell className="text-right tabular-nums">€ {Number(p.unit_price).toFixed(2)}</TableCell>
                    </TableRow>
                  );
                })
              )}
