...
export function RepairForm({ initial, lockClient, submitting, onSubmit, onCancel, submitLabel = "Save", mode = "create" }: Props) {
        ...
        {mode === "edit" && (
          <>
            <div className="space-y-2 sm:col-span-2">
              ...
              <Textarea id="diagnosis" rows={3} value={diagnosis ?? ""} onChange={(e) => setDiagnosis(e.target.value)} />
            </div>
            <div className="space-y-2 sm:col-span-2">
              <Label htmlFor="resolution">Resolution</Label>
              <Textarea id="resolution" rows={3} value={resolution ?? ""} onChange={(e) => setResolution(e.target.value)} />
            </div>
            <div className="space-y-2">
