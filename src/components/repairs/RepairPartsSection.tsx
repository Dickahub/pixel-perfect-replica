          ...
          <TableBody>
            {isLoading ? (
              ...
              rows.map((r) => (
                <TableRow key={r.id}>
                  ...
                  <TableCell className="text-right tabular-nums">{Number(r.unit_price).toFixed(2)}</TableCell>
                  <TableCell className="text-right tabular-nums font-medium">{Number(r.line_total).toFixed(2)}</TableCell>
            ...
            {rows && rows.length > 0 && (
              <TableRow>
                ...
                <TableCell className="text-right tabular-nums font-semibold">€ {total.toFixed(2)}</TableCell>
                <TableCell />
              </TableRow>
            )}
          </TableBody>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="price" type="number" min="0" step="0.01" value={unitPrice} onChange={(e) => setUnitPrice(e.target.value)} />
            </div>
          </div>
        </div>
        <DialogFooter>
